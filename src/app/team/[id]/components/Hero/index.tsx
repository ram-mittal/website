            ...
            <div className="wow fadeInUp max-w-[570px]" data-wow-delay=".2s">
              ...
              <div className="mb-10 border-b border-body-color border-opacity-10 pb-8 dark:border-white dark:border-opacity-10">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  With over a decade of experience in marketing and business development, Mayank has been instrumental in shaping Kaizen into a leading marketing agency. His visionary leadership and deep understanding of digital transformation have helped numerous brands achieve remarkable growth and establish strong market presence.
                </p>
              </div>
                  ...
                  <div className="flex items-center">
                    <span className="mr-3 flex h-10 w-10 items-center justify-center rounded-full bg-primary bg-opacity-10 text-primary">
                      <svg width="20" height="20" viewBox="0 0 20 20" className="fill-current">
                        <path d="M10 1.5C5.3125 1.5 1.5 5.3125 1.5 10C1.5 14.6875 5.3125 18.5 10 18.5C14.6875 18.5 18.5 14.6875 18.5 10C18.5 5.3125 14.6875 1.5 10 1.5ZM10 17.5C6.1875 17.5 3.125 14.5 3.125 10C3.125 5.5 6.1875 2.5 10 2.5C13.8125 2.5 16.875 5.5 16.875 10C16.875 14.5 13.875 17.5 10 17.5Z" />
