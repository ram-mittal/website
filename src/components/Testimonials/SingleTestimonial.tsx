...
const SingleTestimonial = ({
  ...
  testimonial: (typeof TestimonialsData.clients)[0];
}) => {
  const { name, blockquote, occupation } = testimonial;
    ...
    <div className="w-full">
      <div className="rounded-xl bg-white p-8 shadow-two duration-300 hover:shadow-one dark:bg-dark dark:shadow-three dark:hover:shadow-gray-dark lg:px-5 xl:px-8">
        ...
        <div className="flex items-center">
          <div className="relative mr-4 h-[50px] w-full max-w-[50px] overflow-hidden rounded-full bg-gradient-to-tr from-orange-600 via-50% via-purple-500 to-red-600"></div>
          <div className="w-full">
