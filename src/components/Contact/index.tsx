          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              <h2 className="mb-3 text-2xl font-bold text-black dark:text-white sm:text-3xl lg:text-2xl xl:text-3xl">
                Get in Touch with Kaizen
              </h2>
              <p className="mb-8 text-base font-medium text-body-color">
                Ready to elevate your brand? Fill out the form below and our team at Kaizen will get back to you within 24 hours.
              </p>
              <form>
                <div className="-mx-4 flex flex-wrap">
...
How Can We Help You?
                  ...
                  <div className="w-full px-4">
                    <button className="rounded-xl bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark">
                      Send Message
                    </button>
                  </div>
                </div>
